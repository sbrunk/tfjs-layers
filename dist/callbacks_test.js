...
describe('BaseLogger Callback', function () {
    it('Records and averages losses in an epoch', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    baseLogger = new callbacks_1.BaseLogger();
...
describe('History Callback', function () {
    it('onTrainBegin', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    history = new callbacks_1.History();
...
describe('CallbackList', function () {
    it('Constructor with empty arg', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    callbackList = new callbacks_1.CallbackList();
    ...
    it('Constructor and setParams with array of callbacks', function () {
        var history1 = new callbacks_1.History();
        var history2 = new callbacks_1.History();
        var callbackList = new callbacks_1.CallbackList([history1, history2]);
    ...
    it('onTrainBegin', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    history1 = new callbacks_1.History();
                    history2 = new callbacks_1.History();
                    callbackList = new callbacks_1.CallbackList([history1, history2]);
                    return [4, callbackList.onTrainBegin()];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    history1 = new callbacks_1.History();
                    history2 = new callbacks_1.History();
                    callbackList = new callbacks_1.CallbackList([history1]);
                    return [4, callbackList.onTrainBegin()];
                case 1:
                    _a.sent();
                    expect(history1.epoch).toEqual([]);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, callbacks_1.resolveScalarsInLogs(logs)];
                case 1:
                    _a.sent();
...
test_utils_1.describeMathCPUAndGPU('disposeTensorsInLogs', function () {
    it('Resolve mixed numbers and scalars', function () {
        ...
        callbacks_1.disposeTensorsInLogs(logs);
        expect(logs['a']).toEqual(1);
