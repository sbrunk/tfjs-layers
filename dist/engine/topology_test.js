...
describe('Input()', function () {
    ...
    it('produces output that can feed into a Layer.', function () {
        var inputTensor = topology_1.Input({ shape: shape, name: name });
...
test_utils_1.describeMathCPUAndGPU('Container.fromConfig', function () {
    it('creates a minimal Container from simplest config', function () {
        ...
        var container = topology_1.Container.fromConfig(ContainerForTest, config);
...
test_utils_1.describeMathCPUAndGPU('Container', function () {
    ...
    var simpleContainer;
    beforeEach(function () {
        inputTensor = topology_1.Input({ shape: [1], name: inputLayerName, dtype: 'float32' });
...
test_utils_1.describeMathCPUAndGPU('loadWeightsFromJson', function () {
    ...
    it('One layer', function () {
        ...
        topology_1.loadWeightsFromJson(weightsJSON, [denseLayer]);
    ...
    it('Two layers', function () {
        ...
        topology_1.loadWeightsFromJson(weightsJSON, [denseLayer1, denseLayer2]);
    ...
    it('skipMismatch=true tolerates a single missing weight', function () {
        ...
        spyOn(console, 'warn');
        topology_1.loadWeightsFromJson(weightsJSON, [denseLayer], true);
...
test_utils_1.describeMathCPUAndGPU('loadWeightsFromNamedTensorMap', function () {
    ...
    it('One layer', function () {
        ...
        topology_1.loadWeightsFromNamedTensorMap(namedWeightsMap, [denseLayer]);
    ...
    it('Unset weights leads to error', function () {
        ...
        namedWeightsMap[denseLayer.weights[0].originalName] =
            tfjs_core_1.tensor2d([1, 2, 3, 4, 5, 6], [3, 2]);
        expect(function () { return topology_1.loadWeightsFromNamedTensorMap(namedWeightsMap, [denseLayer]); })
